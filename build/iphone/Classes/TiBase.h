...
// in simulator we redefine to format for vibee Developer console
...
{\
	NSString * exceptionName = [@"org.vibee." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.vibee";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIvibeeNativeItemNone = -1, 
	UIvibeeNativeItemSpinner = -2,
	UIvibeeNativeItemProgressBar = -3,
	
	UIvibeeNativeItemSlider = -4,
	UIvibeeNativeItemSwitch = -5,
	UIvibeeNativeItemMultiButton = -6,
	UIvibeeNativeItemSegmented = -7,
	
	UIvibeeNativeItemTextView = -8,
	UIvibeeNativeItemTextField = -9,
	UIvibeeNativeItemSearchBar = -10,
	
	UIvibeeNativeItemPicker = -11,
	UIvibeeNativeItemDatePicker = -12,
	
	UIvibeeNativeItemInfoLight = -13,
	UIvibeeNativeItemInfoDark = -14,
	
	UIvibeeNativeItemDisclosure = -15,
	
	UIvibeeNativeItemContactAdd = -16
};
