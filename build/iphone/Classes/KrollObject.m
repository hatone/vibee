 ...
 * Copyright (c) 2009-2011 by vibee, Inc. All Rights Reserved.
...
//@interface vibeeObject : NSObject
//@end

@interface vibeeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[vibeeObject class]])
		{
			for (NSString *key in [[(vibeeObject*)o modules] allKeys])
			{
